...
int i=0;
    ...
    public void onDrawFrame(GL10 gl){ //dla wyświetlenia nowej ramki
        ...
        if(i%300==0)
        {
            KEngine.PLAYER_BANK_SPEED2 = (float) (KEngine.PLAYER_BANK_SPEED2+0.006);
            KEngine.PLAYER_BANK_SPEED= (float) (KEngine.PLAYER_BANK_SPEED+0.005);
            KEngine.KOLCE_SPEED= (float) (KEngine.KOLCE_SPEED+0.003);
            KEngine.BLOK_SPEED= (float) (KEngine.BLOK_SPEED+0.003);
        }
