...
public class KEngine {
    ...
    public static  float PLAYER_BANK_SPEED=0.17f; //prędkośc poruszania
    public static  float PLAYER_BANK_SPEED2=0.12f;
    ...
    public static float KOLCE_SPEED = 0.03f;//predkość poruszania pierwszego wroga
    public static float BLOK_SPEED=0.036f;//predkość poruszania drugiego wroga
